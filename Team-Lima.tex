...
\subsubsection{Layering layout}
\begin{enumerate}
	\item Visual Layer
	\begin{itemize}
		\item Android Application Layer
		\item Web Application Layer
	\end{itemize}
	\item API Layer
...
\subsubsection{Description of layers}
\textbf{1.\textbullet) Android Application Layer}
	This layer will be concerned with running the program on an Android device.

\textbf{1.\textbullet) Web Application Layer}
	This layer will be concerned with the web application.

\textbf{2. API Layer}
	This layer will provide an Application Programming Interface for the web and Android application to access the rest of the program. Acts as a translator between the base of the application and the visual applications.

\textbf{3. Authentication Layer}
	This layer authenticates the user before it can return data from lower down. Without authentication of the user the process will stop at this layer and not continue further.

\textbf{4. User Layer}
	This layer is concerned with adding new users, updating their profiles their status and anything else related with the user itself.

\textbf{5. Group Layer}
	This layer manages user groups for instance is this user a User, Author or Superuser.

\textbf{6. Project Layer}
	This layer handles all of the things to do with all of the research projects. Editing the meta data of documents and so forth.

\textbf{7. System Layer}
	This layer does the most basic system tasks. Management of organization of data and so forth.
