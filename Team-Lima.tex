...
\begin{itemize}
	\item It is highly pluggable ie. easy to replace a layer
	\begin{itemize}
		\item Mobile application layer
		\item Web page layer
		\item Desktop application layer
	\end{itemize}
	\item Easier to do unit tests on as the other layers are easier to mock
\end{itemize}

For the presentation layer it will be easier to use MVC architecture in every platform (mobile application, web application, desktop application). Each MVC architecture will be a layer and interchanged for the desired platform.

The reason for using MVC(Model View Controller)
\begin{itemize}
