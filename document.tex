...
The server should be available at all times to allow all users to login at anytime. There should be search functionality to allow users to navigate faster.

The system will be web-based and will also built to to run on mobile devices.
...
To run the database we will be using mySQL and php. We will store the user profile using a mySQL database and use.
 
To build the mobile application, we will be using androidStudio(java).
\newpage
